...
#import "LQSHomePageViewController.h"
#import "LQSRecommendViewController.h"

@interface LQSHomePageViewController () <UIScrollViewDelegate>
...
@implementation LQSHomePageViewController
...
- (void)setUpChildVc
{
    LQSRecommendViewController *recommendVc = [LQSRecommendViewController new];
