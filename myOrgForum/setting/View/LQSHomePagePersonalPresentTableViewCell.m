...
@interface LQSHomePagePersonalPresentTableViewCell()
{
    ...
    LQSHomePagePersonalPresentDatailDataModel *_PersonalPresentData;
    CGFloat _picW;
...
@implementation LQSHomePagePersonalPresentTableViewCell
...
- (void)pushesDongmanDataModel:(LQSHomePagePersonalPresentDatailDataModel *)model
{
    _PersonalPresentData = model;
...
- (void)layoutSubviews
{
    ...
    //    来源
    CGSize laiyuanSize = [self sizeWithText:_PersonalPresentData.board_name font:[UIFont systemFontOfSize:12] maxSize:CGSizeMake(kScreenWidth, MAXFLOAT)];
    ...
    //    文字内容
    CGSize size = [self sizeWithText:_PersonalPresentData.title font:[UIFont systemFontOfSize:12] maxSize:CGSizeMake(kScreenWidth, MAXFLOAT)];
